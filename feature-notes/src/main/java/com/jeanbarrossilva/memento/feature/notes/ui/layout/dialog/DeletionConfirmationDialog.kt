package com.jeanbarrossilva.memento.feature.notes.ui.layout.dialog
...
internal fun DeletionConfirmationDialog(
    ...
    Dialog(
        title = { Text(stringResource(R.string.feature_notes_deletion_confirmation_title)) },
        body = { Text(stringResource(R.string.feature_notes_deletion_confirmation_body)) },
        onDismissalRequest,
        modifier
    ) {
